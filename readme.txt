...
Example Commands(Using provided example files):
	-Sender:
		python .\sender.py .\test_file_0 192.168.1.1 192.168.1.0 53 5534 output
	-Sender with encryption:
		python .\sender.py -e .\test_keys_0 .\test_file_0 192.168.1.1 192.168.1.0 53 5534 output
	-Reciever:
		python .\reciever.py output 192.168.1.1 192.168.1.0 recieved
	-Reciever with decryption:
		python .\reciever.py -d .\test_keys_0 output 192.168.1.1 192.168.1.0 recieved